...
function  [Denoising , iter]     =     GSRC_NLP_Denoising( Opts)
    ...
    %           NL_A          =     zeros (b*b, Opts.nblk);
        ...
        for  i  =  1 : K  
            ...
            Weight           =      repmat(wei_arr(:, i)',size(A, 1), 1);       
              ...
              NL_A           =      repmat(sum(Weight.*A, 2), 1, m); %49*60
                  
              TMP            =      GSRC_NLP_CORE( double(A), double(NL_A), Opts.c1, Opts.nSig, Opts.eps);
