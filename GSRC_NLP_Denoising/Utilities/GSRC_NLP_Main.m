function [filename, Sigma, PSNR_Final,FSIM_Final,SSIM_Final, Time_s, iter]     =  GSRC_NLP_Main (filename, Sigma)
...
%[BM3D_PSNR,~]       =    BM3D(Opts.I, Opts.nim, Sigma, 'np', 0);

%disp(sprintf('PSNR of the BM3D Denoised image = %f \n', BM3D_PSNR));


[Denoising ,  iter]              =    GSRC_NLP_Denoising( Opts);
...
Final_denoisng= strcat(filename,'_GSRC_NLP_','_sigma_',num2str(Sigma),'_PSNR_',num2str(PSNR_Final),'_FSIM_',num2str(FSIM_Final),'_SSIM_',num2str(SSIM_Final),'.png');
